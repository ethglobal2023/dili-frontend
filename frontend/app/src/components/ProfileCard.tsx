        ...
        <>
            {loading ? (
                ...
                <div className="flex relative justify-center bg-white w-[1100px]">
                    ...
                    <div className=" flex flex-col w-[60%] gap-[32px]">
                        ...
                        {/* <div className=" ml-10"> */}
                        <div
                            className=" flex items-center justify-center text-gray-800 font-montserrat h-fit  w-[700px]  lg:p-10 p-6  rounded-xl ">
                            <Card
                                className={`
            overflow-hidden
            ${"bg-white"}
            ...
            `}
                                ...
                                <div className=" w-full  p-6 ">
                                                ...
                                                {address.toLowerCase() === cid?.toLowerCase() ? (
                                                    ...
                                                    <Dialog open={open} onOpenChange={setOpen}>
                                                        ...
                                                        <DialogContent className="sm:max-w-[425px]">
                                                            ...
                                                            <div
                                                                className="grid w-full items-center justify-center gap-4 py-4">
                                  ...
                                  "
                                        ...
                                        <div className="w-full flex justify-between ">
                                            {" "}
                                            <div
                                                className="w-full flex items-center text-center justify-center flex-col">
                                                {" "}
                        ...
                        {indexedUser && indexedUser[0].error! !== "Not Found" && (
                            <div
                                className="flex text-center  justify-around text-gray-800 font-montserrat h-fit w-[700px] lg:p-10 p-6  card rounded-xl">
            ...
            transform hover:scale-105`}
                                                >
                                                    <div
                                                        className=" p-4  rounded-[calc(var(--card-radius)-var(--card-padding))] border-blue-300">
                                  ...
                                  />
                                                        ...
                                                        <div
                                                            className=" w-full justify-between items-end text-end flex gap-2 mb-2 mt-4">
                                  ...
                                  {message[0]?.value?.value?.hex &&
                                    BigInt(
                                      message[0]?.value?.value?.hex!
                                                        ...
                                                        <div
                                                            className="w-full  justify-between items-end text-end flex gap-2 mb-[4px]">
                                                            <p className="text-[16px] 1/4 font-sans font-bold text-gray-700 ">
                                                                Expires:{" "}
                                                            </p>
                                                            <div>
