    ...
    useEffect(() => {
            const fetchProfile = async () => {
                try {
                    ...
                    if (stageCid === "self") {
                        console.log("No cid provided, but self, searching supabase for wallet address", walletAddress?.toLowerCase())
                        if (!walletAddress) {
                    ...
                    resumeCache.set(stageCid, {...resume, expiry: Date.now() + 1000 * 60 * 5})
