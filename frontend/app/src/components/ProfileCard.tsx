      ...
      <div className="bg-white w-full">
        ...
        <div className=" flex gap-[32px]">
            ...
            <div className="  text-gray-800 font-montserrat h-fit mt-12 w-[700px] lg:p-10 p-6  card rounded-xl ">
              <div className="profile-info">
                <div>
                  <div className=" flex">
                    <div>
                    <Avatar style={{ width: '8rem', height: '8rem' }} className="rounded-full" {...config} />
                    </div>
          ...
          {fetchedProfile?.attestationData &&
              fetchedProfile?.attestationData?.map((attestation: any,key:any) => {
                ...
                return (
                  <div className="text-gray-800 font-montserrat h-fit mt-12 w-[700px]   card rounded-xl " key={key}>
