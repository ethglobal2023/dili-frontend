  ...
  return (
    <div className="flex justify-center mt-[72px] bg-white w-[1100px]">
      ...
      >
        ...
        <div className=" mx-auto h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 w-36 mb-4"></div>
        ...
        <div className="flex items-center mt-4 space-x-3">
          <div className="flex flex-col items-center w-full mt-2 ">
            ...
            <div className=" w-64 h-2 bg-gray-200 rounded-full dark:bg-gray-700 mb-2"></div>
