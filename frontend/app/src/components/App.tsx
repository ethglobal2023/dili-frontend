...
export const App: React.FC = () => {
  ...
  return (
    <div className="  w-full  h-[85vh] bg-white  ">
      <div
        className={`InboxConversations ${
          isMessages && "overflow-y-hidden"
        } overflow-x-hidden`}
      >
        {/* <BrowserRouter> */}
        {/*<SideBar />*/}
        <div
          className={`${
            !isSearch && "overflow-y-hidden"
          }  overflow-x-hidden min-h-screen bg-white min-w-[400px] max-w-[400px]  border-r-[3px]`}
        >
          <Menu />
          <Routes>
                  ...
                  element={
                    <>
                      <div className="flex w-full  items-center justify-center mt-3">
                        <button
                          className="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg flex dark:shadow-blue-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-3.5 "
                          type="button"
